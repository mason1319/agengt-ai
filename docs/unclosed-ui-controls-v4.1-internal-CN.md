...
| `platform.institution-name.fallback` | 平台机构管理 / 资源用量 / AI 审计 | 机构名称兜底已统一为 `机构名称待完善` | 已收口 | 不再展示 `机构名称待补齐` 这类内部补录口吻 |
...
| `platform.institution-name.fallback` | `机构名称待完善` | 平台机构名称缺失时使用统一兜底，不再散落“待补齐” |
