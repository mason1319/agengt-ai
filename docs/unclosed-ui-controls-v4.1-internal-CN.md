...
| `platform.ai-usage-audit.states` | 平台资源用量 / 智能体中心 | AI 用量与审计日志已补当前筛选、导出范围、空态提示 | 已收口 | 当前筛选 / 导出范围 / 空态提示统一展示，导出空结果和查询空结果不再使用“暂无/未返回”泛化口径 |
| `platform.institution-name.fallback` | 平台机构管理 / 资源用量 / AI 审计 | 机构名称兜底已统一为 `机构名称待完善` | 已收口 | 不再展示 `机构名称待补齐` / `未命名机构` 这类内部补录口吻 |
...
| `platform.institution-name.fallback` | `机构名称待完善` | 平台机构名称缺失时使用统一兜底，不再散落“待补齐 / 未命名机构” |
