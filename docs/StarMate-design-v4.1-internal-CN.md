...
### 9.5 课程与缴费 `/founder/courses`

内部创始人/运营使用。这里可以用表格，因为要做筛选、核对和缴费记录。
...
| 缴费记录 | 已收、未收、实收金额、缴费时间、备注 | `POST /api/v1/founder/payment-records` |
...
| `06 Founder` | 驾驶舱、账号管理、课程发布、缴费记录、课时账户、AI 用量 |
